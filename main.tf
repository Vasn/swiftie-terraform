...
resource "aws_elastic_beanstalk_application" "swiftie_elasticapp" {
  name = "swiftie_elasticapp"
}
 
# Create elastic beanstalk Environment
resource "aws_elastic_beanstalk_environment" "swiftie_beanstalk_env" {
  name                = "swiftie_beanstalk_env"
  application         = aws_elastic_beanstalk_application.swiftie_elasticapp.name
